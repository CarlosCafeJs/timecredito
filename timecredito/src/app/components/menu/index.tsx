...
const Menu = () => {
    return (
        <header className="bg-[#000141] w-full p-5 flex flex-row">
            <Link href="/" >
                <svg width="222" height="52" viewBox="0 0 232 62" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="1" y="1" width="230" height="60" rx="7" stroke="white" stroke-width="2"/>
    <defs>
    ...
    <rect width="232" height="62" rx="8" fill="white"/>
            ...
            <ul className="flex flex-row justify-around w-full text-[#fff] items-center text-2xl font-['SF Compact'] font-light tracking-[.13em] hover:">
                <li className="hover:underline decoration-1"><Link href="/" >Início</Link></li>
                <li className="hover:underline decoration-1"><Link href="/pages/nossas-vantagens" >Nossas Vantagens</Link></li>
                <li className="hover:underline decoration-1"><Link href="/pages/nossa-equipe">Nossa Equipe</Link></li>
                <li className="hover:underline decoration-1"><Link href="/pages/quem-somos">Quem Somos</Link></li>
                <li className="hover:underline decoration-1"><Link href="/pages/tire-suas-duvidas" >Tire suas Dúvidas (FAQ)</Link></li>
